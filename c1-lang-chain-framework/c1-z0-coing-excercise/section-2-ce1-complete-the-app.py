...
def implement_compare_models(prompt):
    ...
    llm33 = implement_llama_3_3_model()

    msg = "tell me a joke about AI"

    llm4_resp = implement_query_model(llm4, msg)
    llm33_resp = implement_query_model(llm33, msg)

    return {"Llama 4": llm4_resp.content, "Llama 3.3": llm33_resp.content}
