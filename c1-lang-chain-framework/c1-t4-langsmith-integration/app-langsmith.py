...
def main():
    print("Hello from c1-t4-langsmith-integration!")

    information = """
    Elon Reeve Musk (EE-lon; born June 28, 1971) is a businessman and entrepreneur known for his leadership of Tesla, SpaceX, X, and xAI. Musk has been the wealthiest person in the world since 2025; as of April 2026, Forbes estimates his net worth to be US$809 billion.
    ...
    summary_template = """
        Give the information {information} about a person, I want to you to create:
        1. A short summary
